...
//
// Copyright 2013-2016 Jetro Lauha (Strobotnik Ltd)
// http://strobotnik.com
// http://jet.ro
//
// $Revision: 1036 $
...
#           endif
    ...
    void OnLevelWasLoaded(int level)
    {
        ...
        if (!sceneName.Equals(newActiveSceneName))
        {
            //Debug.Log("AnalyticsTesting: app screen event - switch to scene " + newActiveSceneName);
            sceneName = newActiveSceneName;
